...
* [Marp CLI](https://github.com/marp-team/marp-cli) ⭐ 3,811 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-08 - A CLI interface for Marp and Marpit-based converters.
...
* [Marp] - The entrance website of Marp ecosystem.
  * [GitHub](https://github.com/marp-team/marp) ⭐ 12,481 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-29 - The GitHub repository of Marp website.
...
* [GROWI](https://github.com/weseek/growi/) ⭐ 1,469 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-10 - Markdown collaboration software including [Marp support](https://docs.growi.org/en/guide/features/presentation.html#what-are-growi-slide-and-marp-slide).
...
* [Marp Core built-in themes](https://github.com/marp-team/marp-core/blob/main/themes/README.md) ⭐ 1,150 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-04 - A documentation for Marp Core built-in themes.
...
* [Awesome Marp](https://github.com/favourhong/Awesome-Marp) ⭐ 1,045 | 🐛 41 | 🌐 HTML | 📅 2026-08-21 - Marp theme set with many useful layouts. 🇨🇳
* [marp-theme-academic](https://github.com/kaisugi/marp-theme-academic) ⭐ 280 | 🐛 0 | 🌐 CSS | 📅 2023-07-14 - A Marp theme with Beamer-like academic style. 🇯🇵
...
* [Neobeam](https://github.com/mikael-ros/neobeam) ⭐ 104 | 🐛 3 | 🌐 CSS | 📅 2026-03-06 - A modern take on LaTeX beamer.
* [teaching-theme-for-marp](https://github.com/eyssette/teaching-theme-for-marp) ⭐ 41 | 🐛 0 | 🌐 HTML | 📅 2021-09-05 - A Marp theme designed for teaching. 🇫🇷
...
* [Cybertopia](https://github.com/noraj/cybertopia-marp) ⭐ 15 | 🐛 1 | 🌐 HTML | 📅 2024-10-06 - A dark theme for Marp / Marpit slides ecosystem using the [Cybertopia Saturated](https://github.com/noraj/cybertopia-highlightjs) ⭐ 7 | 🐛 0 | 🌐 CSS | 📅 2025-06-10 highlight.js theme.
...
* [markdown-it plugins (npm)](https://www.npmjs.com/search?q=keywords:markdown-it-plugin) - A list of published [markdown-it](https://github.com/markdown-it/markdown-it) ⭐ 21,890 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-27 plugins. (may compatible with Marp)
...
* [Marp CLI example](https://github.com/yhatt/marp-cli-example) ⭐ 213 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-09 - An example of Marp CLI automation with GitHub Pages/Netlify/Vercel. (by Marp maintainer)
