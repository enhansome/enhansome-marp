...
* [Marp CLI](https://github.com/marp-team/marp-cli) ⭐ 3,780 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-20 - A CLI interface for Marp and Marpit-based converters.
...
* [Marp Core](https://github.com/marp-team/marp-core) ⭐ 1,144 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-09 - The core library of Marp, based on Marpit framework.
* [Marp] - The entrance website of Marp ecosystem.
  * [GitHub](https://github.com/marp-team/marp) ⭐ 12,401 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-29 - The GitHub repository of Marp website.
...
* [Marpit framework](https://marpit.marp.app) - The skinny framework to create slides from Markdown.
  * [GitHub](https://github.com/marp-team/marpit) ⭐ 1,368 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-03 - The GitHub repository of Marpit framework.
  * [Marpit API](https://marpit-api.marp.app) - The API reference of Marpit framework.

### Community

* [GROWI](https://github.com/weseek/growi/) ⭐ 1,464 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-24 - Markdown collaboration software including [Marp support](https://docs.growi.org/en/guide/features/presentation.html#what-are-growi-slide-and-marp-slide).
...
* [Marp Core built-in themes](https://github.com/marp-team/marp-core/blob/main/themes/README.md) ⭐ 1,144 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-09 - A documentation for Marp Core built-in themes.
...
* [Awesome Marp](https://github.com/favourhong/Awesome-Marp) ⭐ 1,039 | 🐛 41 | 🌐 HTML | 📅 2026-08-21 - Marp theme set with many useful layouts. 🇨🇳
...
* [markdown-it plugins (npm)](https://www.npmjs.com/search?q=keywords:markdown-it-plugin) - A list of published [markdown-it](https://github.com/markdown-it/markdown-it) ⭐ 21,838 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-13 plugins. (may compatible with Marp)
