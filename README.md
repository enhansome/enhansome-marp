...
* [Marp CLI](https://github.com/marp-team/marp-cli) ⭐ 3,838 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-08 - A CLI interface for Marp and Marpit-based converters.
...
* [Marp] - The entrance website of Marp ecosystem.
  * [GitHub](https://github.com/marp-team/marp) ⭐ 12,564 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-29 - The GitHub repository of Marp website.
...
* [Marpit framework](https://marpit.marp.app) - The skinny framework to create slides from Markdown.
  * [GitHub](https://github.com/marp-team/marpit) ⭐ 1,381 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-04 - The GitHub repository of Marpit framework.
  * [Marpit API](https://marpit-api.marp.app) - The API reference of Marpit framework.

### Community

* [GROWI](https://github.com/weseek/growi/) ⭐ 1,470 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-26 - Markdown collaboration software including [Marp support](https://docs.growi.org/en/guide/features/presentation.html#what-are-growi-slide-and-marp-slide).
...
* [Neobeam](https://github.com/mikael-ros/neobeam) ⭐ 106 | 🐛 3 | 🌐 CSS | 📅 2026-03-06 - A modern take on LaTeX beamer.
...
* [markdown-it plugins (npm)](https://www.npmjs.com/search?q=keywords:markdown-it-plugin) - A list of published [markdown-it](https://github.com/markdown-it/markdown-it) ⭐ 21,943 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-12 plugins. (may compatible with Marp)
