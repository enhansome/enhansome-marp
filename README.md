...
* [Marp CLI](https://github.com/marp-team/marp-cli) ⭐ 3,789 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-20 - A CLI interface for Marp and Marpit-based converters.
* [Marp for VS Code](https://github.com/marp-team/marp-vscode) ⭐ 2,081 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-11 - An extension of Marp for [Visual Studio Code](https://code.visualstudio.com/).
...
* [Marp] - The entrance website of Marp ecosystem.
  * [GitHub](https://github.com/marp-team/marp) ⭐ 12,430 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-29 - The GitHub repository of Marp website.
...
* [Marpit framework](https://marpit.marp.app) - The skinny framework to create slides from Markdown.
  * [GitHub](https://github.com/marp-team/marpit) ⭐ 1,373 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-03 - The GitHub repository of Marpit framework.
  * [Marpit API](https://marpit-api.marp.app) - The API reference of Marpit framework.

### Community

* [GROWI](https://github.com/weseek/growi/) ⭐ 1,464 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-31 - Markdown collaboration software including [Marp support](https://docs.growi.org/en/guide/features/presentation.html#what-are-growi-slide-and-marp-slide).
...
* [markdown-it plugins (npm)](https://www.npmjs.com/search?q=keywords:markdown-it-plugin) - A list of published [markdown-it](https://github.com/markdown-it/markdown-it) ⭐ 21,865 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-27 plugins. (may compatible with Marp)
