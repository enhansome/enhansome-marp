...
* [Marp] - The entrance website of Marp ecosystem.
  * [GitHub](https://github.com/marp-team/marp) ⭐ 12,535 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-29 - The GitHub repository of Marp website.
...
* [Awesome Marp](https://github.com/favourhong/Awesome-Marp) ⭐ 1,049 | 🐛 41 | 🌐 HTML | 📅 2026-08-21 - Marp theme set with many useful layouts. 🇨🇳
...
* [markdown-it plugins (npm)](https://www.npmjs.com/search?q=keywords:markdown-it-plugin) - A list of published [markdown-it](https://github.com/markdown-it/markdown-it) ⭐ 21,928 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-12 plugins. (may compatible with Marp)
