...
* [Marp CLI](https://github.com/marp-team/marp-cli) ⭐ 3,760 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-20 - A CLI interface for Marp and Marpit-based converters.
...
* [Marp Core](https://github.com/marp-team/marp-core) ⭐ 1,143 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-09 - The core library of Marp, based on Marpit framework.
* [Marp] - The entrance website of Marp ecosystem.
  * [GitHub](https://github.com/marp-team/marp) ⭐ 12,362 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-29 - The GitHub repository of Marp website.
...
* [Marpit framework](https://marpit.marp.app) - The skinny framework to create slides from Markdown.
  * [GitHub](https://github.com/marp-team/marpit) ⭐ 1,363 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-03 - The GitHub repository of Marpit framework.
  * [Marpit API](https://marpit-api.marp.app) - The API reference of Marpit framework.

### Community

* [GROWI](https://github.com/weseek/growi/) ⭐ 1,464 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-15 - Markdown collaboration software including [Marp support](https://docs.growi.org/en/guide/features/presentation.html#what-are-growi-slide-and-marp-slide).
* [Marp Slides for Obsidian](https://github.com/samuele-cozzi/obsidian-marp-slides) ⭐ 264 | 🐛 32 | 🌐 CSS | 📅 2026-04-11 - A plugin for [Obsidian](https://obsidian.md/).
...
* [Marp Core built-in themes](https://github.com/marp-team/marp-core/blob/main/themes/README.md) ⭐ 1,143 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-09 - A documentation for Marp Core built-in themes.
...
* [Awesome Marp](https://github.com/favourhong/Awesome-Marp) ⭐ 1,033 | 🐛 47 | 🌐 HTML | 📅 2024-05-29 - Marp theme set with many useful layouts. 🇨🇳
* [marp-theme-academic](https://github.com/kaisugi/marp-theme-academic) ⭐ 278 | 🐛 0 | 🌐 CSS | 📅 2023-07-14 - A Marp theme with Beamer-like academic style. 🇯🇵
* [marpstyle](https://github.com/cunhapaulo/marpstyle) ⭐ 205 | 🐛 0 | 🌐 CSS | 📅 2026-07-23 - The set of Marp themes, designed with simplicity and beauty as first class prerequisites.
* [Rosé Pine](https://github.com/rainbowflesh/Rose-Pine-For-Marp) ⭐ 106 | 🐛 1 | 🌐 CSS | 📅 2023-07-18 - Marp themes using [Rosé Pine](https://rosepinetheme.com/) palettes.
* [Neobeam](https://github.com/mikael-ros/neobeam) ⭐ 101 | 🐛 3 | 🌐 CSS | 📅 2026-03-06 - A modern take on LaTeX beamer.
* [teaching-theme-for-marp](https://github.com/eyssette/teaching-theme-for-marp) ⭐ 40 | 🐛 0 | 🌐 HTML | 📅 2021-09-05 - A Marp theme designed for teaching. 🇫🇷
...
* [Cybertopia](https://github.com/noraj/cybertopia-marp) ⭐ 14 | 🐛 1 | 🌐 HTML | 📅 2024-10-06 - A dark theme for Marp / Marpit slides ecosystem using the [Cybertopia Saturated](https://github.com/noraj/cybertopia-highlightjs) ⭐ 7 | 🐛 0 | 🌐 CSS | 📅 2025-06-10 highlight.js theme.
...
* [markdown-it plugins (npm)](https://www.npmjs.com/search?q=keywords:markdown-it-plugin) - A list of published [markdown-it](https://github.com/markdown-it/markdown-it) ⭐ 21,815 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13 plugins. (may compatible with Marp)
...
* [@kazumatu981/markdown-it-kroki](https://github.com/kazumatu981/markdown-it-kroki) ⭐ 12 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-01 - markdown-it plugin (mainly designed for Marp), to support [Kroki](https://kroki.io/) powered embedding diagrams.
* [@kazumatu981/markdown-it-fontawesome](https://github.com/kazumatu981/markdown-it-fontawesome) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2025-07-19 - markdown-it plugin (mainly designed for Marp), to support [Font Awesome](https://fontawesome.com/) icons.

## Examples

* [Marp CLI example](https://github.com/yhatt/marp-cli-example) ⭐ 213 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-11 - An example of Marp CLI automation with GitHub Pages/Netlify/Vercel. (by Marp maintainer)
